...
function BMHotbarClass:StartTheme()
    self._mauiThemeToken = themeBridge.push()
    -- Force MAUI theme across ButtonMaster windows; do not layer BM themes on top.
    return 0, 0

    -- Unreachable legacy BM theme code retained below for future toggle support.
...
function BMHotbarClass:EndTheme(themeColorPop, themeStylePop)
    ...
    if self._mauiThemeToken then
        themeBridge.pop(self._mauiThemeToken)
        self._mauiThemeToken = nil
    end
end
