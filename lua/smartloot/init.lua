...
mq.imgui.init("SmartLoot", function()
    ...
    ImGui.PushStyleColor(ImGuiCol.WindowBg, 0.03, 0.05, 0.10, 0.94); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.ChildBg, 0.02, 0.03, 0.08, 0.98); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.TitleBg, 0.02, 0.03, 0.07, 1.00); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.TitleBgActive, 0.03, 0.05, 0.12, 1.00); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.Button, 0.10, 0.18, 0.31, 0.95); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.ButtonHovered, 0.16, 0.27, 0.44, 1.00); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.ButtonActive, 0.21, 0.33, 0.52, 1.00); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.FrameBg, 0.09, 0.15, 0.26, 0.95); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.FrameBgHovered, 0.14, 0.22, 0.36, 1.00); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.Header, 0.10, 0.18, 0.31, 0.95); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.HeaderHovered, 0.16, 0.27, 0.44, 1.00); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.HeaderActive, 0.21, 0.33, 0.52, 1.00); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.Border, 0.74, 0.66, 0.34, 0.95); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.Separator, 0.44, 0.52, 0.72, 0.90); _sl_colors = _sl_colors + 1
    ImGui.PushStyleColor(ImGuiCol.Text, 1.00, 0.95, 0.20, 1.00); _sl_colors = _sl_colors + 1
    -- Main UI Window
    ...
    if _sl_colors > 0 then ImGui.PopStyleColor(_sl_colors) end
